...
//	http://structure.io
//
//  ScanViewController+OpenGL.swift
//
...
extension ScanViewController {
    ...
    func renderSceneForDepthFrame(_ depthFrame: STDepthFrame, colorFrame: STColorFrame?) {
        ...
        case .scanning:
            ...
            _display!.cubeRenderer!.renderCubeOutline (withCameraPose: cameraViewpoint, depthTestEnabled: true, occlusionTestEnabled: false)
